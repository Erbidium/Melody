...
namespace Melody.Infrastructure.Data {
    ...
    internal class SqlScriptsResource {
        ...
        ///  AND (@Sear [остаток строки не уместился]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на SELECT UserId,
        ///       AuthorName,
        ///       StartYear,
        ///       EndYear,
        ///       GenreId,
        ...
        ///      WHERE fs.UserId = @Use [остаток строки не уместился]&quot;;.
        /// </summary>
        ...
        ///        WHERE ur.RoleId = 1
        ///          AND ur.UserId = U [остаток строки не уместился]&quot;;.
        /// </summary>
